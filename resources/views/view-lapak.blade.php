  ...
  <section id="container">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a class="#" href="pedagang">
              <i class="fa fa-user"></i>
              <span>Pedagang</span>
              </a>
          </li>
          <li class="sub-menu">
            <a class="active" href="Lapak">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Data Lapak/Kios </h3>
        <div class="row mb">
          <!-- page start-->
          <div class="content-panel">
            <div class="adv-table">
              <table class="display table table-bordered">
                <thead>
                  <tr>
                    <th style="width: 30px;">ID Lapak</th>
                    <th style="width: 50px;">Blok</th>
                    <th class="hidden-phone">Pemilik</th>
