        ...
        <div class="row content-panel">
            <div class="col-lg-10 col-lg-offset-1">
                ...
                <table class="table">
                    ...
                    <tr>
                        @php
                            $total_harga = $lapak->harga_sewa * $sewa->periode;
                        @endphp
                        <td class="text-center">{{ $sewa->periode }}</td>
                        <td>Sewa lapak {{ $lapak->posisi }}</td>
            ...
            <form action="{{ route('admin.pedagang.store') }}" class="form-send text-right" method="POST">
                @csrf
