...
@section('content')
    <h3><i class="fa fa-angle-right"></i> Penambahan Data Transaksi Sewa</h3>
    <div class="row mt">
        <div class="col-lg-6 col-md-6 col-sm-6">
            <h4 class="title">Data transaksi</h4>
            <div id="message"></div>
            <form class="contact-form php-mail-form" role="form" action="{{ route('admin.transaksi-sewa.after-create') }}" method="POST">
                @csrf
