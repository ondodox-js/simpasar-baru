...
<body>
	...
	<header class="header-section">
		...
		<nav class="header-nav">
			<ul class="main-menu">
			<li><a href="/">Home</a></li>
				<li><a href="profil" class="active">Profile</a></li>
				<li><a href="lokasi">Denah</a>
					<!-- <ul class="sub-menu">
				...
				<li><a href="harga-barang">Harga Barang Komoditas</a></li>
				<li><a href="dashboard">Login</a></li>
			</ul>
			<div class="header-right">
				<a href="#" class="hr-btn"><i class="flaticon-029-telephone-1"></i>Contact </a>
	...
	<section class="page-top-section set-bg" data-setbg="assets/img/page-top-bg/1.jpg">
		<div class="container">
			...
			<nav class="site-breadcrumb">
				...
				<span class="sb-item active">Profile</span>
			</nav>
		</div>
	</section>
	<!-- Page top Section end -->
	...
	<section class="about-section spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-5">
					<img src="assets/img/pasarbanjar.jpg" alt="">
				</div>
				<div class="col-lg-7">
					<div class="about-text">
						<h2>Pasar Banjar Patroman</h2>
						<p>Seiring dengan berjalannya waktu, akhirnya Pasar Banjar telah selesai direnovasi atau lebih tepatnya lagi direvitalisasi, karena semua bangunan yang ada dihancurkan untuk kemudian dibangun kembali, dengan catatan tidak merubah bentuk dan denah asalnya. Sekarang ini Pasar Banjar telah kembali ditempati oleh para pedagang/penghuninya, yang pada waktu proses pembangunannya untuk sementara waktu para pedagang Pasar Banjar berdagang di pasar sementara yang berlokasi di terminal bus Kota Banjar. Penandatanganan prasasti pun telah dilakukan oleh Walikota Banjar sebagai tanda telah diresmikannya Pasar Banjar ini. Saking demikian konsennya pihak Pemerintah Kota Banjar di bawah kepemimpinan Walikota Banjar, khususnya untuk Pasar Banjar ini akan diganti namanya menjadi Patroman Plaza yang direncanakan juga buka sampai malam hari.</p>
						<a href="#" class="site-btn">Lebih Banyak</a>
					</div>
				</div>
			</div>
		</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></div>
	...
	<script>
          ...
          valueAxis6.calculateTotals = true;
          // valueAxis6.renderer.minWidth = 50;


          var series21 = chart6.series.push(new am4charts.ColumnSeries3D());
          series21.columns.template.width = am4core.percent(60);
          series21.columns.template.tooltipText =
          "{name}: {valueY}";
          series21.name = "Delivered";
          series21.dataFields.categoryX = "category";
          series21.dataFields.valueY = "value1";
          series21.dataItems.template.locations.categoryX = 0.5;
          series21.stacked = true;
          series21.columns.template.fill = am4core.color("#81ff93");
          series21.columns.template.stroke = am4core.color("#81ff93");
          series21.tooltip.pointerOrientation = "vertical";
          series21.tooltipText = "{name}: [bold]{valueY}";
	</script>
