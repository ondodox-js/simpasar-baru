...
<body>
  ...
  <div id="login-page">
    <div class="container">
      <form class="form-login" action="{{ route('auth-pedagang') }}" method="POST">
        @csrf
        <h2 class="form-login-heading">sign in now</h2>
        <div class="login-wrap @error('nik') has-error @enderror">
          <input type="text" class="form-control" placeholder="Nomor Induk Kependudukan" autofocus required name="nik">
          @error('nik')
