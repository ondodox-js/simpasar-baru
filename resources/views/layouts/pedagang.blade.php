...
<head>
  ...
  <title>Dashio - Bootstrap Pedagang Template</title>
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended tasks-bar">
              ...
              <li>
                <a href="index.html#">
                  <div class="task-info">
                    <div class="desc">Dashio Pedagang Panel</div>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered">{{ Pedagang::user()->nama_lengkap }}</h5>
          <li class="mt">
            <a class="{{ Route::is('pedagang.index') ? 'active' : '' }} link" href="{{ route('pedagang.index') }}">
              <i class="fa fa-dashboard"></i>
              <span>Dashboard</span>
              </a>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="{{ request()->is('pedagang/*') ? 'active' : '' }} link">
              <i class="fa fa-money"></i>
              <span>Data transaksi</span>
              </a>
            <ul class="sub">
              <li class="{{ request()->is('pedagang/lapak') ? 'active' : '' }}">
                <a href="{{ route('pedagang.lapak') }}">Lapak</a>
              </li>
              <li class="{{ request()->is('pedagang/pembayaran') ? 'active' : '' }}">
                <a href="{{ route('pedagang.pembayaran') }}">Pembayaran</a>
              </li>
              {{-- <li class="{{ request()->is('pedagang/transaksi/sewa') ? 'active' : '' }}">
                <a href="{{ route('pedagang.transaksi.sewa') }}">Pembayaran sewa</a>
              </li>
              <li class="{{ request()->is('pedagang/transaksi/retribusi') ? 'active' : '' }}">
                <a href="{{ route('pedagang.transaksi.retribusi') }}">Pembayaran retribusi</a>
              </li> --}}
            </ul>
          </li>
          <li>
