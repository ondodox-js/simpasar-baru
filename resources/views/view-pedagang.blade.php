  ...
  <section id="container">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            <a class="#" href="barang-komoditas">
              <i class="fa fa-shopping-cart"></i>
              <span>Barang Komoditas</span>
              </a>
          </li>
          <li class="sub-menu">
            <a class="active" href="pedagang">
          ...
          <li class="sub-menu">
            <a class="#" href="Lapak">
              ...
              <span>Data Lapak/Kios</span>
              </a>
          </li>
          <li class="sub-menu">
            <a class="#" href="Retribusi">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Data Pedagang</h3>
        <div class="row mb">
          <!-- page start-->
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered">
                <thead>
                  <tr>
                    <th>ID Lapak</th>
                    <th>ID Barang</th>
                    <th class="hidden-phone">ID Pedagang</th>
                    <th class="hidden-phone">Nama Pedagang</th>
                ...
                @foreach($user as $dt)
                  <tr class="gradeX">
                    <td>{{ $dt->id_lapak }}</td>
                    <td>{{ $dt->id_barang }}</td>
                    <td>{{ $dt->id_pedagang }}</td>
                    <td>{{ $dt->nama_pedagang }}</td>
                    <td>{{ $dt->alamat }}</td>
                    <td>{{ $dt->telepon }}</td>
                    <td>{{ $dt->nama_kategori }}</td>
                    <td>{{ $dt->status }}</td>
                    <td><a href="#" data-toggle="tooltip" title="Edit"><i class="fa fa-edit" style="font-size:24px;"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="#" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" style="font-size:24px;"></i></a></td>
                  </tr>
                  @endforeach      
                </tbody>
              </table>
